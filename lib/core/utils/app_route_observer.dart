...
class AppRouteObserver extends RouteObserver<PageRoute<dynamic>> {
  ...
  void didReplace({Route<dynamic>? newRoute, Route<dynamic>? oldRoute}) {
    ...
    if (newRoute is PageRoute) {
      updateCurrentScreen(
        getScreenName(newRoute),
        args: newRoute.settings.arguments as Map<String, dynamic>?,
      );
    }
  }
  ...
  void updateCurrentScreen(
    ...
    screenChangeStreamCtrl.add(
      ScreenChangeModel(screenName: screen, args: args),
    );
    if (switchTab) {
      homeTabChangeStreamCtrl.add(
        ScreenChangeModel(screenName: screen, args: args),
      );
    }
