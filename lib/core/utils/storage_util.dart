...
class StorageUtil {
  ...
  static Future<bool> putString(String key, String data) async =>
      pref.setString(key, data);
  static Future<bool> putInt(String key, int data) async =>
      pref.setInt(key, data);
  static Future<bool> putBool(String key, {required bool data}) async =>
      pref.setBool(key, data);
  static Future<bool> putDouble(String key, double data) async =>
      pref.setDouble(key, data);
  static Future<bool> putStringList(String key, List<String> data) async =>
