...
class RefreshInterceptor extends QueuedInterceptor {
  ...
  Future<void> handleRefreshTokenFailed(
    DioException err,
  ...
  Future<void> onError(
    ...
    if (requestOptions != null &&
        dioResponse?.statusCode == ApiStatusCode.Unauthorized) {
      final shouldCheckRefreshToken =
          requestOptions.extra['shouldCheckRefreshToken'] as bool? ?? true;
      if (shouldCheckRefreshToken) {
        ...
        if (requestOptions.headers['Authorization'] ==
          ...
          await recallApi(requestOptions)
