...
import 'package:jobdi/core/extensions/bool_extension.dart';
...
class DebugInterceptor extends Interceptor {
  ...
  void onResponse(
    ...
    AppLogger.d(
      'API SUCCESS - ${response.realUri} - ${response.statusCode} - ${response.statusMessage}',
    );
  ...
  String _renderCurlRepresentation(RequestOptions requestOptions) {
    ...
    try {
      ...
      curl =
          'unable to create a CURL representation of the requestOptions (Error: $err)';
    }
    return curl;
  }
